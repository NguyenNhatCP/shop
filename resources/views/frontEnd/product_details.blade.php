...
@section('content')
    <div class="container">
        ...
        <div class="product-details"><!--product-details-->
            ...
            <div class="col-sm-7">
                <form action="{{route('addToCart', ['id'=>$detail_product->id])}}" method="post" role="form">
                    ...
                    <input type="hidden" name="price" value="{{number_format($detail_product->price, 0, '', ',')}} VNĐ" id="dynamicPriceInput">
                    <div class="product-information"><!--/product-information-->
                        <img src="{{asset('frontEnd/images/product-details/new.jpg')}}" class="newarrival" alt="" />
                        <h2>{{$detail_product->p_name}}</h2>
                        <p>Code ID: {{$detail_product->p_code}}</p>
                        <span>
                            <span id="dynamic_price">{{number_format($detail_product->price, 0, '', ',')}} VNĐ</span>
