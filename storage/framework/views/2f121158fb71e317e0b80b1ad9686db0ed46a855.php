    ...
    <div class="container-fluid">
        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                <form action="<?php echo e(route('product.update',$edit_product->id)); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="controls">
                            <select name="categories_id" style="width: 415px;">
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($key); ?>"<?php echo e($edit_category->id==$key?' selected':''); ?>><?php echo e($value); ?></option>
                                    <?php
                                    if($key!=0){
                                        $sub_categories=DB::table('categories')->select('id','name')->where('parent_id',$key)->get();
                                        if(count($sub_categories)>0){
                                            foreach ($sub_categories as $sub_category){?>
                                                <option value="<?php echo e($sub_category->id); ?>"<?php echo e($edit_category->id==$sub_category->id?' selected':''); ?>>&nbsp;&nbsp;--<?php echo e($sub_category->name); ?></option>
                                           <?php }
                                        }
                                    }
                                    ?>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls<?php echo e($errors->has('p_name')?' has-error':''); ?>">
                            <input type="text" name="p_name" id="p_name" class="form-control" value="<?php echo e($edit_product->p_name); ?>" title="" required="required" style="width: 400px;">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls<?php echo e($errors->has('p_code')?' has-error':''); ?>">
                            <input type="text" name="p_code" id="p_code" class="form-control" value="<?php echo e($edit_product->p_code); ?>" title="" required="required" style="width: 400px;">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls<?php echo e($errors->has('p_color')?' has-error':''); ?>">
                            <input type="text" name="p_color" id="p_color" value="<?php echo e($edit_product->p_color); ?>" required="required" style="width: 400px;">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls<?php echo e($errors->has('description')?' has-error':''); ?>">
                            <textarea class="textarea_editor span12" name="description" id="description" rows="6" placeholder="Product Description" style="width: 580px;"><?php echo e($edit_product->description); ?></textarea>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls<?php echo e($errors->has('price')?' has-error':''); ?>">
                            <div class="input-prepend"> <span class="add-on">$</span>
                                <input type="number" name="price" id="price" class="" value="<?php echo e($edit_product->price); ?>" title="" required="required">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <?php if($edit_product->image!=''): ?>
                                &nbsp;&nbsp;&nbsp;
                                <a href="javascript:" rel="<?php echo e($edit_product->id); ?>" rel1="delete-image" class="btn btn-danger btn-mini deleteRecord">Delete Old Image</a>
                                <img src="<?php echo e(url('products/small/',$edit_product->image)); ?>" width="35" alt="">
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="control-group">
