        ...
        <div class="row">
            ...
            <div class="col-sm-9 padding-right">
                <div class="features_items">
                    <h2 class="title text-center">Danh mục >> Kết quả Tìm kiếm</h2>
                    <p class="title text-center" style="color:darkgoldenrod">Tìm thấy <?php echo e(count($products)); ?> sản phẩm</p>
